...
bool LIS3DH_ReadReg(u8_t Reg, u8_t* Data)
{
    ...
    ASSERT(spi_master_tx_rx((uint32_t *)NRF_SPI1,transfer_size,SPIMasterBuffer,SPISlaveBuffer));
...
u8_t LIS3DH_WriteReg(u8_t WriteAddr, u8_t Data)
{
    ...
    ASSERT(spi_master_tx_rx((uint32_t *)NRF_SPI1,SPIWriteLength,SPIMasterBuffer,SPISlaveBuffer));
