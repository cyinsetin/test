...
void timer_initial(void)
{
	uint32_t err_code;
	 ...
	 err_code = app_timer_create(&pedometer_timer,
                                        ...
                                        pedometer_handler);
	err_code = app_timer_start(pedometer_timer, APP_TIMER_TICKS(20, APP_TIMER_PRESCALER), NULL);
