...
#define Vibrator_off()			nrf_gpio_pin_clear(VIBRATION_IO)
#define Vibrator_on()				nrf_gpio_pin_set(VIBRATION_IO)
//#define Vibrator_off()			nrf_gpio_pin_clear(VIBRATION_IO)
//#define Vibrator_on()				nrf_gpio_pin_set(VIBRATION_IO)
...
#define RX_PIN_NUMBER  15 //11
#define TX_PIN_NUMBER  14 //9
